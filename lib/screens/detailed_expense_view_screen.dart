...
class DetailedExpenseViewScreen extends StatefulWidget {
  final String uid;
  const DetailedExpenseViewScreen({super.key, required this.uid});

  @override
  State<DetailedExpenseViewScreen> createState() =>
      _DetailedExpenseViewScreenState();
}
            ...
            SizedBox(
                ...
                child: StreamBuilder(
                    ...
                    builder: (context, snapshot) {
                      ...
                      List<MapEntry<String, int>> categoryList =
